...
public class Parser2Tests {
    ...
    public void testClassParsing() throws Exception {
        ...
        List list = List.of(
                ...
                new Token(Token.TokenTypes.NEWLINE, 4, 4),
...
class TranExample implements someName,someNameTwo
    ...
    public void testClassImplements() throws Exception {
        ...
        List list = List.of(
                ...
                //new Token(Token.TokenTypes.NEWLINE, 4, 2), //Why is there a newline token supposed to be here (same for 8,2)???
                ...
                new Token(Token.TokenTypes.NEWLINE, 11, 4),
